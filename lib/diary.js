...
Diary.prototype.printExercisesByIncreasing = function () {
  ...
  var exercisesByIncreasingCal = _.orderBy(currentExercises, ['calories'], ['asc'])
  diary.clearExerciseOptionsTable();
  exercisesByIncreasingCal.forEach(function(exercise){
...
Diary.prototype.printExercisesByDecreasing = function () {
  ...
  var currentExercises = JSON.parse(exercisesJSON);
  var exercisesByIncreasingCal = _.orderBy(currentExercises, ['calories'], ['desc'])
  diary.clearExerciseOptionsTable();
  exercisesByIncreasingCal.forEach(function(exercise){
    $('#exercises-diary-table').append(`<tr>
      <td class='selected-exercises'><input id=${exercise.name} type='checkbox'></td>
...
Diary.prototype.clearExerciseOptionsTable = function () {
  // $('#exercises-diary-table').children().children().first().nextAll().html()
  var headers = $('#exercises-diary-table').children().children().first()
  $('#exercises-diary-table').html(`${headers.html()}`)
};
