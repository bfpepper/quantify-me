...
Diary.prototype.setBreakfastTable = function () {
  ...
  currentDiaries[0].breakfast = diary.breakfast.foods
...
Diary.prototype.setLunchTable = function () {
  ...
  currentDiaries[0].lunch = diary.lunch.foods
  diaryJSON = JSON.stringify(currentDiaries)
  localStorage.setItem('diary', diaryJSON)
  this.lunchTable();
};
...
Diary.prototype.setDinnerTable = function () {
  ...
  currentDiaries[0].dinner = diary.dinner.foods
  diaryJSON = JSON.stringify(currentDiaries)
  localStorage.setItem('diary', diaryJSON)
  this.dinnerTable();
};
...
Diary.prototype.setSnacksTable = function () {
  ...
  currentDiaries[0].snacks = diary.snacks.foods
  diaryJSON = JSON.stringify(currentDiaries);
  localStorage.setItem('diary', diaryJSON);
  this.snacksTable();
};
...
Diary.prototype.setExerciseTable = function () {
  ...
  currentDiaries[0].exercises = diary.exercises.exercises
  diaryJSON = JSON.stringify(currentDiaries);
  localStorage.setItem('diary', diaryJSON);
  this.exerciseTable();
};
