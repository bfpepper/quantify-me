...
Diary.prototype.setBreakfastTable = function () {
  ...
  if(typeof(currentDiaries[0].breakfast) === 'undefined'){
...
Diary.prototype.exerciseTable = function () {
  ...
  $('#diary-exercise-table').append(`<tr class="cal-totals-row">
    <td>Total Calories</td>
    <td class='calorie-total'>${diary.exercises.totalCalories}</td>
    </tr>`);
  diary.clearCheckboxes();
};
...
var loadDiary = function() {
  ...
  currentDiaries.forEach(function(diary) {
    newDiary.breakfast.foods     = diary.breakfast;
    newDiary.lunch.foods         = diary.lunch;
    newDiary.dinner.foods        = diary.dinner;
    newDiary.snacks.foods        = diary.snacks;
    newDiary.exercises.exercises = diary.exercises;
  })
  debugger;
  return newDiary;
}
