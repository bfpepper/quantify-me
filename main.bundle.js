...
/***/ function(module, exports, __webpack_require__) {
	...
	var Exercise = __webpack_require__(8);
	var Diary = __webpack_require__(10);
	...
	setDiaryExercisesTable = function () {
	  ...
	  currentExercises.forEach(function (exercise, index) {
	    $('#exercises-diary-table').append(`<tr>
	      <td class='selected-exercises'><input id=${exercise.name} index=${index} type='checkbox'></td>
	...
	setDiaryFoodsTable = function () {
	  ...
	  currentExercises.forEach(function (food, index) {
	    $('#foods-diary-table').append(`<tr>
	      <td class='selected-foods'><input id=${food.name} index=${index} type='checkbox'></td>
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = __webpack_require__(1);
	var thing = __webpack_require__(3);
	...
	Food.prototype.clearTable = function () {
	  $('.food-table').html('' + '<tr>' + '<th>Name</th>' + '<th>Calories</th>' + '<th>Delete</th>' + '</tr>');
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "tr:nth-child(even) {\n  background-color: lightgrey;\n}\n\ntable {\n  border: 1px solid grey;\n  border-radius: 20px;\n}\n\ntr {\n    border: 1px solid darkgrey;\n}\n\n.cal-totals-row {\n  background-color: lightgrey;\n}\n\n.red {\n  color: red;\n}\n\n.green {\n  color: green;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = __webpack_require__(1);
	var thing = __webpack_require__(3);
	var htmlHandler = __webpack_require__(9);
	var error = __webpack_require__(7);
	...
	Exercise.prototype.clearTable = function () {
	  $('.exercise-table').html('' + '<tr>' + '<th>Name</th>' + '<th>Calories</th>' + '<th>Delete</th>' + '</tr>');
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var diaryExercises = __webpack_require__(15);
	...
	Diary.prototype.clearBreakfastTable = function () {
	  $('.breakfast-table').html('' + '<tr>' + '<th>Name</th>' + '<th>Calories</th>' + '<th></th>' + '</tr>');
	};
	...
	Diary.prototype.clearLunchTable = function () {
	  $('.lunch-table').html('' + '<tr>' + '<th>Name</th>' + '<th>Calories</th>' + '<th></th>' + '</tr>');
	};
	...
	Diary.prototype.clearDinnerTable = function () {
	  $('.dinner-table').html('' + '<tr>' + '<th>Name</th>' + '<th>Calories</th>' + '<th></th>' + '</tr>');
	};
	...
	Diary.prototype.clearSnacksTable = function () {
	  $('#diary-snacks-table').html('' + '<tr>' + '<th>Name</th>' + '<th>Calories</th>' + '<th></th>' + '</tr>');
	};
	...
	Diary.prototype.clearExerciseTable = function () {
	  $('#diary-exercise-table').html('' + '<tr>' + '<th>Name</th>' + '<th>Calories</th>' + '<th></th>' + '</tr>');
	};
	...
	Diary.prototype.calculateConsumedCalories = function () {
	  return this.snacks.totalCalories + this.dinner.totalCalories + this.breakfast.totalCalories + this.lunch.totalCalories;
	};
	...
	Diary.prototype.printExercisesByIncreasing = function () {
	  ...
	  var exercisesByIncreasingCal = _.orderBy(currentExercises, function (i) {
	...
	Diary.prototype.printExercisesByDecreasing = function () {
	  var diary = this;
	  var currentExercises = diary.findExercises();
	  var exercisesByDecreasingCal = _.orderBy(currentExercises, function (i) {
	    return parseInt(i.calories);
	  }, ['desc']);
	  diary.clearExerciseOptionsTable();
	...
	Diary.prototype.printFoodsByIncreasing = function () {
	  ...
	  var foodsByIncreasingCal = _.orderBy(currentFoods, function (i) {
	    return parseInt(i.calories);
	  }, ['asc']);
	...
	Diary.prototype.printFoodsByDecreasing = function () {
	  var diary = this;
	  var currentFoods = diary.findFoods();
	  var foodsByDecreasingCal = _.orderBy(currentFoods, function (i) {
	    return parseInt(i.calories);
	  }, ['desc']);
	  diary.clearFoodOptionsTable();
